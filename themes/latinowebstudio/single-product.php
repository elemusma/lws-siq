...
// print_r($categoryDetails);
	...
	endwhile; // end of the loop.
		...
		if($categoryDetails['name'] == 'Flash Fashion') {
			echo '<a href="' . home_url() . '/flash-fashion/" class="btn-main small" style="margin-left:0px;margin-bottom:-20px;">Go Back to Flash Fashion</a>';
		} else {
		echo '<a href="' . $categoryDetails['url'] . '" class="btn-main small" style="margin-left:0px;margin-bottom:-20px;">Go Back to ' . $categoryDetails['name'] . '</a>';
