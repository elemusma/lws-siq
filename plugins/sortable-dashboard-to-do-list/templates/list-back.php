    ...
    <ul id="<?php echo $list_id; ?>" class="sdtdl-list">
        ...
        foreach ($list_data as $key => $to_do_item) {
            ...
            ?>" data-key="<?php echo (int)$key; ?>" data-added="<?php echo (int)$to_do_item['added']; ?>" data-edited="<?php echo (int)$to_do_item['last_edited']; ?>"
                ...
                data-edit-allowed="<?php echo (int)($to_do_item['edition_allowed'] ?? 0); ?>"
                    ...
                    <div class="sdtdl-dates">
                        ...
                        <div class="sdtdl-date-edited">
                            <?php if ($to_do_item['last_edited']) {
                                ...
                                echo '<span class="dashicons dashicons-edit"></span>' . sprintf(esc_html__("Last edit %s by %s", 'sortable-dashboard-to-do-list'), $date_edited, $to_do_item['last_edited_by']);
                            } ?>
                        </div>
                    </div>
                    <?php if ($list_id != 'sdtdl-affected-list') { ?>
...
<?php } ?>
    ...
    <div class="sdtdl-dialog-content sdtdl-new-item" title="<?php esc_attr_e('Add New To-Do Item', 'sortable-dashboard-to-do-list'); ?>">
        <div class="sdtdl-new-container">
            ...
            <label for="new-sdtdl-text" class="screen-reader-text"><?php esc_html_e('Description (optional)', 'sortable-dashboard-to-do-list'); ?></label><textarea id="new-sdtdl-text" rows="<?php echo apply_filters("sdtdl-min-description-rows","4");?>"
            ...
            if ($users) { ?>
                ...
                <?php } ?>
                <label for="sdtdl-new-allow-edition" class="sdtdl-allow-edition">
                    <input id="sdtdl-new-allow-edition" type="checkbox" name="allow-edition"/>
                    <?php esc_html_e('Allow affected users to edit the task description', 'sortable-dashboard-to-do-list'); ?>
                </label>
            <?php } ?>
        </div>
    </div>
    <div class="sdtdl-dialog-content sdtdl-edit-item" title="<?php esc_attr_e('Edit To-Do Item', 'sortable-dashboard-to-do-list'); ?>">
        <div class="sdtdl-edit-container">
            <label for="edit-sdtdl-title" class="screen-reader-text"></label><input type="text" id="edit-sdtdl-title"
                                                                                    placeholder="<?php esc_attr_e('Title (required)', 'sortable-dashboard-to-do-list'); ?>"/>
            <label for="edit-sdtdl-text" class="screen-reader-text"></label><textarea id="edit-sdtdl-text" rows="<?php echo apply_filters("sdtdl-min-description-rows","4");?>"
                                                                                      placeholder="<?php esc_attr_e('Description (optional)', 'sortable-dashboard-to-do-list'); ?>"></textarea>
            ...
            if ($users) { ?>
                ...
                <?php } ?>
                <label for="sdtdl-edit-allow-edition" class="sdtdl-allow-edition">
                    <input id="sdtdl-edit-allow-edition" type="checkbox" name="allow-edition"/>
                    <?php esc_html_e('Allow affected users to edit the task description', 'sortable-dashboard-to-do-list'); ?>
                </label>
            <?php } ?>
        </div>
