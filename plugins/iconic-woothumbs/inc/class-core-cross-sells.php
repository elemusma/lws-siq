...
class Iconic_WooThumbs_Core_Cross_Sells {
	 ...
	 *
	 * @var Iconic_WooThumbs_Core_License_Uplink
	 */
	...
	public static function get_api_sidebars() {
		...
		$sidebars  = self::get_remote_data( 'iconic_api_sidebars_iconic-woothumbs', '/wp-json/wp/v2/iconic-api-sidebars?plugin_id=iconic-woothumbs', $base_url );
