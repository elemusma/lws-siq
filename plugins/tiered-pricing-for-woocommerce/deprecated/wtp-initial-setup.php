			...
			<tbody class="wc-shipping-class-rows" id="wtp-user-role-discounts">
				...
				if ( $general_role_rules ) {
					foreach ( $general_role_rules as $key => $value ) {
						...
						echo '<tr>';
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-1" data-value="' . $value['role'] . '" colspan="">' . $value['role_text'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-2" colspan="">' . $value['min_qty'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-3" colspan="">' . $max_qty . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-4" colspan="">' . $value['discount_value'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-5" colspan="">' . $value['discount_type'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
			...
			<tbody id="wtp-user-type-discounts" class="wc-shipping-class-rows">
				...
				if ( $general_user_rules ) {
					foreach ( $general_user_rules as $key => $value ) {
						...
						echo '<tr>';
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-1" data-value="' . $value['user'] . '" colspan="">' . $value['user_text'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-2" colspan="">' . $value['min_qty'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-3" colspan="">' . $max_qty . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-4" colspan="">' . $value['discount_value'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-5" colspan="">' . $value['discount_type'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
			...
			<tbody class="wc-shipping-class-rows" id="wtp-category-role-discounts">
				...
				if ( $general_category_rules ) {
					foreach ( $general_category_rules as $key => $value ) {
						...
						echo '<tr>';
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-1" data-value="' . $value['category'] . '" colspan="">' . $value['category_text'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-2" colspan="">' . $value['min_qty'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-3" colspan="">' . $max_qty . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-4" colspan="">' . $value['discount_value'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
						echo wp_kses_post( '<td class="wc-shipping-classes-blank-state col-5" colspan="">' . $value['discount_type'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
	...
	public function add_admin_field_user_roles_management( $value ) {
		...
		if ( ! empty( $new_user_roles ) && count( $new_user_roles ) > 0 ) {
			foreach ( $new_user_roles as $key => $value ) {
				...
				echo '<tr>';
				echo wp_kses_post( '<td class="wc-shipping-classes-blank-state" colspan="">' . $value['user_role'] . '</td>' ); // nosemgrep audit.php.wp.security.xss.unescaped-stored-option
