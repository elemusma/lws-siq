...
if ( 'one' === $sub_section ) { // This will show Display Type Setting  
	$settings = array(
		...
		array(
			'name' => __('Tier Pricing Item Text', 'wtp'),
			'type'    => 'text',
			'id'      => 'wtp_item_text',
		...
		array(
			...
			'options' => array(
				...
				'woocommerce_product_meta_end' => __( 'Before Product Summary', 'wtp' ),
				'woocommerce_product_after_tabs' => __( 'After Product Summary', 'wtp' ),
			),
