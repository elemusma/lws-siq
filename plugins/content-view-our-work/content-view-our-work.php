<?php
/**
 * Plugin Name:       Content View Our Work
 ...
 * Text Domain:       content-view-our-work
 *
 * @package CreateBlock
 */
 ...
 */
function create_block_content_view_our_work_block_init() {
...
add_action( 'init', 'create_block_content_view_our_work_block_init' );
