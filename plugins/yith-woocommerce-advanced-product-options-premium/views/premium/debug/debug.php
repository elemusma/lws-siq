		...
		<div class="">
            ...
            <div class="field-wrap">
                ...
                <div class="field">
                    ...
                    $new_columns   = array( 'name', 'product_association', 'exclude_products', 'user_association', 'exclude_users' );
                    ...
                    if ( ! empty( $existing_columns ) ) {
                        ...
                        foreach( $should_exists as $column_name ) {
                            if ( in_array( $column_name, $new_columns ) ) {
                                $column_name = '<b>' . $column_name . '</b>';
                            }
                            ?>

                            <div style="display: flex; flex-direction: column; align-items: center;">
                                <span style="font-size: 15px;"><?php echo wp_kses_post( $column_name ); ?></span>
