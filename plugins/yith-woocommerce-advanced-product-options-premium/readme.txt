...
4.16.0 - Released on 07 August 2024

* New: support for WooCommerce 9.2
* New: integration with WPML Multi Currency
* Tweak: do not calculate add-on values until a variation is selected
* Fix: selected by default option with WPML
* Fix: edit link duplicated when updating quantity in the Cart block
* Fix: datepicker ui width responsive
* Fix: woodmartThemeModule.productImages is not a function
* Dev: new action 'yith_wapo_after_add_order_item_meta'
* Dev: new filter 'yith_wapo_show_edit_product_link'

4.15.0 - Released on 11 July 2024

* New: support for WordPress 6.6
* New: support for WooCommerce 9.1
* Tweak: show preview of SVG image in add-on type Upload
* Update: YITH plugin framework
* Fix: replace image with conditional logic
* Fix: select-option.php template path
* Fix: wrong calculations with the YITH Product Bundles plugin
* Dev: added arguments to filters

4.14.0 - Released on 25 June 2024

* New: support for WooCommerce 9.0
* Update: YITH plugin framework
* Fix: add price suffix for options and total price
* Fix: enqueue wp-color-picker script issue with Divi
* Fix: replace add-on image in Elementor widget
* Fix: replace total price
* Fix: product price for variations
* Fix: required upload after changing variation
* Fix: selection type single or multiple for input text and textarea
* Fix: add-on prices with Multi Currency plugin
* Dev: minor fixes
* Dev: PHP 8.2 compatibility
