...
class Iconic_Flux_Checkout_Elements {
	...
	public static function on_wp_hook() {
		$wc_ajax = filter_input( INPUT_GET, 'wc-ajax', FILTER_SANITIZE_SPECIAL_CHARS );
	...
	public static function save_meta_box( $post_id ) {
		$position = filter_input( INPUT_POST, 'fce_position' );
		$settings = filter_input( INPUT_POST, 'fce_settings' );
		$nonce    = filter_input( INPUT_POST, 'fce_metabox_nonce' );
	...
	public static function is_publicly_queryable() {
		...
		$request_uri       = basename( filter_input( INPUT_SERVER, 'REQUEST_URI', FILTER_SANITIZE_URL ) );
